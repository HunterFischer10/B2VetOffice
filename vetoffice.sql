...
ALTER TABLE `diagnosis`
  ...
  ADD KEY `fk_diagnosis_animals_idx` (`IDanimal`);
...
--
ALTER TABLE `diagnosis`
  ADD CONSTRAINT `fk_diagnosis_animals` FOREIGN KEY (`IDanimal`) REFERENCES `animals` (`IDanimal`) ON DELETE NO ACTION ON UPDATE NO ACTION;
